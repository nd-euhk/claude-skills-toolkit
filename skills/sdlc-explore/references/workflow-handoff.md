...
Workflow xử lý: idempotent retry (phase đã hoàn thành auto-skipped), SRS/HLD/LLD/IMP+TST cho single service, gate verification với tối đa 3 lần retry, auto concurrency.
