...
Advisory mode is lighter than design/review — no gate verification, outputs are consultative.
...
- **Context:** Relevant project artifacts (SRS, ADRs, existing architecture, constraints)
