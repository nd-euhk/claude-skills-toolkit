...
Deeper toolkit for stuck-ness: `problem-solving`. Long multi-step chains with explicit
revision: `sequential-thinking`. This skill governs how single conclusions get made and
