...
### When Stuck (Dispatch)
**Location:** `references/when-stuck/SKILL.md`
...
**Location:** `references/collision-zone-thinking/SKILL.md`
...
### Inversion Exercise
**Location:** `references/inversion-exercise/SKILL.md`
...
**Location:** `references/simplification-cascades/SKILL.md`
