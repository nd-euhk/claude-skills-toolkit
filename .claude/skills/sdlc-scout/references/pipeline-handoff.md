...
| `mode = 'review'` + ≤200 files | `scout` skill (no pipeline) |
...
→ log warning: "Scout pipeline không tìm thấy. Dùng scout skill thay thế."
→ fall back to scout skill for all sub-projects
