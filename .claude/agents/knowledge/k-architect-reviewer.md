...
**Trước khi viết, đọc template chính thức tùy theo chế độ:**
```
.claude/templates/hld/ADR-TEMPLATE.md                   (ADR — Chế độ 1)
.claude/templates/hld/C4-context-diagram-TEMPLATE.md    (C4 diagram — Chế độ 3)
.claude/templates/hld/architecture-TEMPLATE.md           (Kiến trúc tổng thể)
.claude/templates/hld/hard-boundaries-TEMPLATE.md        (Ranh giới bảo mật — Chế độ 2, 3)
.claude/templates/supporting/conventions-TEMPLATE.md     (Coding conventions — Chế độ 2)
```
